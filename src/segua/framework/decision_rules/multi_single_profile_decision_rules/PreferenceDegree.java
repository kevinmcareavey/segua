...
import segua.data_structures.PartitionedBBA;
...
public class PreferenceDegree extends MultiSingleProfileDecisionRule {
	...
	public PreferenceDegree(MultiSingleProfileGame<BBAPayoff> s) {
		super(s);
		constructBBAs();
	}
	...
	public PlayerPairPayoffSingle<NormalFormPayoff> getNormalForm(AttackerType t, PureStrategyProfile p) {
		return new PlayerPairPayoffSingle<NormalFormPayoff>(
				new DoublePayoff(getDefenderPreferenceDegree(t, p)),
				new DoublePayoff(getAttackerPreferenceDegree(t, p))
		);
	}
